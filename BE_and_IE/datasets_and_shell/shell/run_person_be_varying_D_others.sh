...
#python ../dataset/proc.py ${baseConfigFile} ${outputConfigFile} 1.0 no 1 1 ${ratio} 1.0 20
    ...
    python ../dataset/proc.py ${baseConfigFile} ${outputConfigFile} 1.0 no 0 1 ${ratio} 1.0 20 0.1 5
    #hdfs dfs -rm '/tmp/enrich/'${data[${dataID}]}'/config_run.json'
    #hdfs dfs -put ${outputConfigFile} '/tmp/enrich/'${data[${dataID}]}'/config_run.json'
    #cd /root/project/enrich/discovery/
    cd ..
