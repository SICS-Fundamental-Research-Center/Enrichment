...
dataID=1
task="varying_G"
outputFilePrefix="./results/varying_G"
...
#python ../dataset/proc.py ${baseConfigFile} ${outputConfigFile} 1.0 no 1 1 1.0 ${ratio} 20
    ...
    #./run_enrich_unit.sh 'enrich_'${data[${dataID}]} 'enrich_'${data[${dataID}]} '/tmp/enrich/'${data[${dataID}]}'/config_run.json' ${outputFilePrefix}'_'${data[${dataID}]}'_ratio'${ratio}'_ours.txt'
...
python ../dataset/proc.py ${baseConfigFile} ${outputConfigFile} 1.0 no 0 1 1.0 ${ratio} 20 0.1 5
    #hdfs dfs -rm '/tmp/enrich/'${data[${dataID}]}'/config_run.json'
    #hdfs dfs -put ${outputConfigFile} '/tmp/enrich/'${data[${dataID}]}'/config_run.json'
    #cd /root/project/enrich/discovery/
    cd ..
    ./run_enrich_unit.sh './shell/configAll_others/config_run.json' >> ${outputFilePrefix}'_'${data[${dataID}]}'_ratio'${ratio}'_others.txt'
    cd ./shell/
    #cd /root/project/enrich/discovery/enrich/shell
    # download results    
