...
python ../dataset/proc.py ${baseConfigFile} ${outputConfigFile} 1.0 no 1 1 1.0 ${ratio} 20 0.1 5
    ...
    #python ../dataset/proc.py ${baseConfigFile} ${outputConfigFile} 1.0 no 0 1 1.0 ${ratio} 20
    #hdfs dfs -rm '/tmp/enrich/'${data[${dataID}]}'/config_run.json'
    #hdfs dfs -put ${outputConfigFile} '/tmp/enrich/'${data[${dataID}]}'/config_run.json'
    #cd /root/project/enrich/discovery/
